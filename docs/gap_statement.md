...
| 2 | Kilungeja et al. 2025 | Direct comparator: machine-learning-based menstrual phase identification from wearable signals | **VERIFIED** | S2 (direct comparator) | Read 2026-04-23 (`docs/s44294-025-00078-8.pdf`). **Different dataset:** University of North Florida in-house collection with Empatica E4 / EmbracePlus wristbands, n=18 ovulatory subjects, 65 cycles. **NOT mcPHASES.** Endpoint: 3-phase or 4-phase classification with calendar-window labels around urine-strip LH test. No conformal prediction, no abstention, no uncertainty modeling. Plan §2.5 differentiation table holds on every row; "Dataset" is a clean additional differentiator. Plan §1.5 note "used same dataset" is factually incorrect — see plan_v4.1_changelog.md amendment 7. |
...
3. ~~Kilungeja et al. 2025 (row 2) is the single citation most capable of sinking the paper.~~ **Verified 2026-04-23: Kilungeja used a different dataset (UNF / Empatica E4 + EmbracePlus, n=18). Plan §1.5 note "used same dataset" is incorrect; see plan_v4.1_changelog.md amendment 7. Differentiation table in plan §2.5 is intact and now strengthened by a "Dataset" row.**
